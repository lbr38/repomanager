 ...
 *  Local deb repo
 */
$rawParams['repo-id'] = 'local-deb-for-test-user2|bookworm|main';
$rawParams['action'] = 'create';
$rawParams['package-type'] = 'deb';
$rawParams['repo-type'] = 'local';
$rawParams['source'] = '';
$rawParams['alias'] = 'local-deb-for-test-user2';
$rawParams['dist'] = 'bookworm';
$rawParams['section'] = 'main';
$rawParams['env'] = ['pprd'];
$rawParams['description'] = 'CI - test API - local deb repo for test-user2';
$rawParams['group'] = '';
