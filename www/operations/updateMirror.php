...
if ($OS_FAMILY == "Redhat") {
	$op->repo = new Repo(compact('repoName', 'repoSource', 'repoType', 'repoGpgCheck', 'repoGpgResign'));
}
if ($OS_FAMILY == "Debian") {
	$op->repo = new Repo(compact('repoName', 'repoDist', 'repoSection', 'repoType', 'repoSource', 'repoGpgCheck', 'repoGpgResign'));
}
