...
if ($OS_FAMILY == "Redhat") {
	$op->repo = new Repo(compact('repoName', 'repoSource', 'repoType', 'repoGroup', 'repoDescription', 'repoGpgCheck',  'repoGpgResign', 'repoType'));
}
if ($OS_FAMILY == "Debian") {
	$op->repo = new Repo(compact('repoName', 'repoSource', 'repoDist', 'repoSection', 'repoType', 'repoGroup', 'repoDescription', 'repoGpgCheck',  'repoGpgResign', 'repoType'));
}
