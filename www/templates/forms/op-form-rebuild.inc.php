    ...
    <td>
        <label class="onoff-switch-label">
            <?php if ($myrepo->getPackageType() == 'rpm') : ?>
                <input name="repoGpgResign" param-name="targetGpgResign" type="checkbox" class="onoff-switch-input task-param" value="yes" <?php echo (RPM_SIGN_PACKAGES == "true") ? 'checked' : ''; ?>>
            <?php endif ?>
            <?php if ($myrepo->getPackageType() == 'deb') : ?>
                <input name="repoGpgResign" param-name="targetGpgResign" type="checkbox" class="onoff-switch-input task-param" value="yes" <?php echo (DEB_SIGN_REPO == "true") ? 'checked' : ''; ?>>
            <?php endif ?>
