...
if (!empty($source)) echo "<tr><th>REPO SOURCE :</th><td>${source}</td></tr>";
if (!empty($name)) echo "<tr><th>NOM DU REPO :</th><td>${name}</td></tr>";
if (!empty($dist)) echo "<tr><th>DISTRIBUTION :</th><td>${dist}</td></tr>";
if (!empty($section)) echo "<tr><th>SECTION :</th><td>${section}</td></tr>";
if (!empty($targetDescription)) echo "<tr><th>DESCRIPTION :</th><td>${targetDescription}</td></tr>";
...
if (!empty($targetGroup)) echo "<tr><th>AJOUT AU GROUPE :</th><td>${targetGroup}</td></tr>";
echo "</table>";
?>