        ...
        <table>
            ...
            <tr field-type="mirror rpm deb">
                ...
                <td>
                    <label class="onoff-switch-label">
                        <input name="repoGpgCheck" type="checkbox" class="onoff-switch-input task-param" value="true" param-name="gpg-check" package-type="all" checked />
            ...
            <tr field-type="mirror rpm deb">
                ...
                <td>
                    <label class="onoff-switch-label" field-type="mirror rpm">
                        <input name="repoGpgResign" type="checkbox" class="onoff-switch-input task-param type_rpm" value="true" param-name="gpg-sign" package-type="rpm" <?php echo (RPM_SIGN_PACKAGES == "true") ? 'checked' : ''; ?> />
                        <span class="onoff-switch-slider"></span>
                    </label>
                    <label class="onoff-switch-label" field-type="mirror deb">
                        <input name="repoGpgResign" type="checkbox" class="onoff-switch-input task-param type_deb" value="true" param-name="gpg-sign" package-type="deb" <?php echo (DEB_SIGN_REPO == "true") ? 'checked' : ''; ?> />
                        <span class="onoff-switch-slider"></span>
                    </label>
                </td>
            </tr>
            ...
            <tr field-type="mirror local rpm deb">
                ...
                <td field-type="mirror local rpm">
                    <select class="task-param" param-name="rpm-arch" package-type="rpm" multiple>
                        <?php
                ...
                <td field-type="mirror local deb">
                    <select class="task-param" param-name="deb-arch" package-type="deb" multiple>
                        <?php
