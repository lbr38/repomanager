    ...
    if ($totalHosts >= 1) : ?>
        ...
        <div class="hosts-charts-container">
            <div class="hosts-chart-sub-container div-generic-blue">
                ...
                <div class="echart-container">
                    <div id="hosts-count-chart-loading" class="flex justify-center align-item-center height-100">
            ...
            <div class="hosts-chart-sub-container div-generic-blue">
                ...
                <div class="echart-container">
                    <div id="hosts-os-chart-loading" class="flex justify-center align-item-center height-100">
                        <img src="/assets/icons/loading.svg" class="icon-np" />
                    </div>
            ...
            <div class="hosts-chart-sub-container div-generic-blue">
                ...
                <div class="echart-container">
                    <div id="hosts-arch-chart-loading" class="flex justify-center align-item-center height-100">
                        <img src="/assets/icons/loading.svg" class="icon-np" />
                    </div>
            ...
            <div class="hosts-chart-sub-container div-generic-blue">
                ...
                <div class="echart-container">
                    <div id="hosts-env-chart-loading" class="flex justify-center align-item-center height-100">
                        <img src="/assets/icons/loading.svg" class="icon-np" />
                    </div>
            ...
            <div class="hosts-chart-sub-container div-generic-blue">
                ...
                <div class="echart-container">
                    <div id="hosts-agent-status-chart-loading" class="flex justify-center align-item-center height-100">
                        <img src="/assets/icons/loading.svg" class="icon-np" />
                    </div>
            ...
            <div class="hosts-chart-sub-container div-generic-blue">
                ...
                <div class="echart-container">
                    <div id="hosts-agent-version-chart-loading" class="flex justify-center align-item-center height-100">
                        <img src="/assets/icons/loading.svg" class="icon-np" />
                    </div>
        ...
        <script>
            $(document).ready(function() {
                new EChart('pie', 'hosts-count-chart');
                new EChart('bar', 'hosts-os-chart');
                new EChart('pie', 'hosts-arch-chart');
                new EChart('pie', 'hosts-env-chart');
                new EChart('pie', 'hosts-agent-status-chart');
                new EChart('pie', 'hosts-agent-version-chart');
            });
        </script>
        <?php
    endif; ?>
