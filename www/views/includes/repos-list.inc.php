...
if (!empty($groupsList)) {
    foreach ($groupsList as $groupName) : ?>
        <div class="repos-list-group div-generic-blue" group="<?= $groupName ?>">
            <img src="/assets/icons/up.svg" class="hideGroup pointer float-right icon-lowopacity" group="<?= $groupName ?>" state="visible" />
            <h3><?= $groupName ?></h3>
            ...
            foreach ($reposList as $repoArray) : ?>
                <div class="repos-list-group-flex-div">
                    <?php
