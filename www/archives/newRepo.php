...
function updateReposLists(array $variables = []) {
	...
	if ($OS_FAMILY == "Redhat") {
		if (!file_put_contents("$REPOS_LIST", "Name=\"${repoName}\",Realname=\"${repoSource}\",Env=\"${DEFAULT_ENV}\",Date=\"${DATE_JMA}\",Description=\"${repoDescription}\"", FILE_APPEND)) {
	...
	if ($OS_FAMILY == "Debian") {
		if (!file_put_contents("$REPOS_LIST", "Name=\"${repoName}\",Host=\"${repoSource}\",Dist=\"${repoDist}\",Section=\"${repoSection}\",Env=\"${DEFAULT_ENV}\",Date=\"${DATE_JMA}\",Description=\"${repoDescription}\"", FILE_APPEND)) {
 ...
 */
 ...
 try {
	...
	if ($OS_FAMILY == "Redhat") { printDetails(compact('stepLog', 'repoName', 'repoSource', 'repoGpgCheck', 'repoGpgResign', 'repoGroup', 'repoDescription'));}
 	if ($OS_FAMILY == "Debian") { list($repoHost, $repoRoot) = printDetails(compact('stepLog', 'repoName', 'repoDist', 'repoSection', 'repoSource', 'repoGpgCheck', 'repoGpgResign', 'repoGroup', 'repoDescription'));}
 ...
 */
 ...
 try {
	...
	if (!file_exists($stepLog)) { touch($stepLog); }
	if ($OS_FAMILY == "Redhat") { createRepo(compact('stepLog', 'repoName', 'repoSource', 'repoGroup', 'repoDescription'));}
	if ($OS_FAMILY == "Debian") { createRepo(compact('stepLog', 'repoName', 'repoDist', 'repoSection', 'repoSource', 'repoGroup', 'repoDescription'));}
...
try {
	...
	if (!file_exists($stepLog)) { touch($stepLog); }
	if ($OS_FAMILY == "Redhat") { updateReposLists(compact('stepLog', 'repoName', 'repoSource', 'repoGroup', 'repoDescription'));}
	if ($OS_FAMILY == "Debian") { updateReposLists(compact('stepLog', 'repoName', 'repoDist', 'repoSection', 'repoSource', 'repoGroup', 'repoDescription'));}
