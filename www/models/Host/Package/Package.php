...
class Package extends \Models\Model
{
    ...
    public function getIdByNameVersion(string $packageName, string|null $packageVersion) : int|bool
    {
        ...
        if (!empty($packageName) and !empty($packageVersion)) {
            try {
                $stmt = $this->db->prepare("SELECT Id FROM packages WHERE Name = :name and Version = :version");
         ...
         */
            ...
            try {
                $stmt = $this->db->prepare("SELECT Id FROM packages WHERE Name = :name");
                $stmt->bindValue(':name', $packageName);
                $result = $stmt->execute();
            } catch (Exception $e) {
                DbLog::error($e);
    ...
    public function getPackageInfo(string $packageId) : array
    {
        ...
        try {
            $stmt = $this->db->prepare("SELECT * FROM packages WHERE Id = :packageId");
    ...
    public function getPackageState(string $packageName, string|null $packageVersion) : string
    {
        try {
            ...
            if (!empty($packageVersion)) {
                $stmt = $this->db->prepare("SELECT State FROM packages WHERE Name = :name and Version = :version");
                $stmt->bindValue(':version', $packageVersion);
             ...
             */
                ...
                $stmt = $this->db->prepare("SELECT State FROM packages WHERE Name = :name");
            }
    ...
    public function getInstalled() : array
    {
        ...
        try {
            $result = $this->db->query("SELECT * FROM packages WHERE State = 'inventored' or State = 'installed' or State = 'dep-installed' or State = 'upgraded' or State = 'downgraded'");
        } catch (Exception $e) {
            DbLog::error($e);
        }
    ...
    public function generateTimeline(string $package) : array
    {
        ...
        try {
            $stmt = $this->db->prepare("SELECT * FROM packages_history
            WHERE Name = :package
    ...
    {
        try {
            $stmt = $this->db->prepare("UPDATE packages SET Version = :version, Date = :date, Time = :time, State = :state, Id_event = :id_event WHERE Name = :name");
    ...
    {
        try {
            $stmt = $this->db->prepare("INSERT INTO packages_history ('Name', 'Version', 'State', 'Type', 'Date', 'Time', 'Id_event') VALUES (:name, :version, :state, :type, :date, :time, :id_event)");
            $stmt->bindValue(':name', $packageName);
            $stmt->bindValue(':version', $packageVersion);
    ...
    public function addPackage(string $name, string $version, string $state, string $type, string $date, string $time, string|null $eventId) : void
    {
        try {
            if (!empty($eventId)) {
                $stmt = $this->db->prepare("INSERT INTO packages ('Name', 'Version', 'State', 'Type', 'Date', 'Time', 'Id_event') VALUES (:name, :version, :state, :type, :date, :time, :id_event)");
                $stmt->bindValue(':id_event', $eventId);
            } else {
                $stmt = $this->db->prepare("INSERT INTO packages ('Name', 'Version', 'State', 'Type', 'Date', 'Time') VALUES (:name, :version, 'inventored', 'package', :date, :time)");
            }
            $stmt->bindValue(':name', $name);
            $stmt->bindValue(':version', $version);
            $stmt->bindValue(':state', $state);
    ...
    {
        try {
            $stmt = $this->db->prepare("DELETE FROM packages_available WHERE Name = :name and Version = :version");
            $stmt->bindValue(':name', $packageName);
            $stmt->bindValue(':version', $packageVersion);
            $stmt->execute();
        } catch (Exception $e) {
    ...
    {
        $this->db->exec("DELETE FROM packages_available");
        $this->db->exec("VACUUM");
    }
    ...
    {
        try {
            $stmt = $this->db->prepare("SELECT * FROM packages WHERE Name = :name");
            $stmt->bindValue(':name', $name);
            $result = $stmt->execute();
        } catch (Exception $e) {
            DbLog::error($e);
    ...
    {
        try {
            $stmt = $this->db->prepare("SELECT * FROM packages_available WHERE Name = :name");
            $stmt->bindValue(':name', $name);
            $result = $stmt->execute();
        } catch (Exception $e) {
            DbLog::error($e);
    ...
    {
        try {
            $stmt = $this->db->prepare("SELECT * FROM packages_available WHERE Name = :name and Version = :version");
            $stmt->bindValue(':name', $name);
            $stmt->bindValue(':version', $version);
            $result = $stmt->execute();
        } catch (Exception $e) {
