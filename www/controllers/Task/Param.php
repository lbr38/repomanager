...
trait Param
{
    ...
    public function taskParamsSet($taskParams, $requiredParams = null, $optionnalParams = null)
    {
        ...
        $setters = array(
            ...
            /**
             *  In case of creating a new repo, the source can be either a rpm or a deb one
             */
            'rpm-source' => 'setSource',
            'deb-source' => 'setSource',

            /**
             *  In case of creating a new repo, the arch can be either a rpm or a deb one
             *  Else the arch is defined by the source repo
             */
            'rpm-arch' => 'setArch',
            'deb-arch' => 'setArch',
            'arch' => 'setArch',
