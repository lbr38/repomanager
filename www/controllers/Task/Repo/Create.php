...
class Create
{
    ...
    public function __construct(string $taskId)
    {
         ...
         */
        $requiredParams = array('package-type', 'repo-type');
        ...
        if ($taskParams['repo-type'] == 'mirror') {
            if ($taskParams['package-type'] == 'rpm') {
                $requiredParams[] = 'rpm-source';
                $requiredParams[] = 'rpm-arch';
            }
            if ($taskParams['package-type'] == 'deb') {
                $requiredParams[] = 'deb-source';
    ...
    private function local()
    {
        ...
        try {
             ...
             */
            $this->repo->addSnap($this->repo->getDate(), $this->repo->getTime(), 'no', $this->repo->getArch(), array(), $this->repo->getType(), 'active', $this->repo->getRepoId());
