...
class Process
{
    ...
    private $command;
    private $env = ['HOME' => ROOT, 'PATH' => '/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin'];
    private $process;
    private $pipes;
    private $pid;
     ...
     */
    public function getOutput(string $filePath = '') : string
    {
        /**
     ...
     */
    public function setBackground(bool $runInBackground) : void
    {
