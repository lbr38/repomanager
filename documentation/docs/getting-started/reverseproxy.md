...
Here is an example of an Nginx reverse proxy vhost:
...
| ``<PATH_TO_CERTIFICATE>`` | /etc/ssl/certs/repomanager.crt |
| ``<PATH_TO_PRIVATE_KEY>`` | /etc/ssl/private/repomanager.key |
...
Open your web browser and connect to ``https://<FQDN>``.
