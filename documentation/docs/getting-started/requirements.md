...
- :material-harddisk: Please use a SSD disk to avoid disk I/O and latency issues
...
- :material-email-fast-outline: A least a SPF record configured for your FQDN, to be able to send emails from Repomanager
